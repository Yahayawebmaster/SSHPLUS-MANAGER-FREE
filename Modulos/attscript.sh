...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/24clan/SSHPLUS-MANAGER-FREE/master/Install/versao
...
echo -e "                              \033[1;31mBy 24clanteam\033[1;36m"
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;36m    SCRIPT IS NOW UPDATED!\033[1;32m\n"

  rm /tmp/att > /dev/null 2>&1

  echo -e " \033[1;33mMORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@crazy_vpn\n"
  ...
  echo -e "  \033[1;33mMORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@24CLAN_OFFICIAL_GROUP\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://raw.githubusercontent.com/24clan/SSHPLUS-MANAGER-FREE/master/Plus > /dev/null 2>&1
